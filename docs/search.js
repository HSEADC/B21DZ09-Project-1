...
function getSearchRequest() {
  var url = new URL(window.location.href); // const url = new URL('http://localhost:8080/search.html')
...
function setSearchRequest(requestText) {
  var url = getPathFromUrl(window.location.href); // const url = getPathFromUrl('http://localhost:8080/search.html')
...
function createContentCard(contentItemData) {
  ...
  contentItem.href = contentItemData.link; // const contentItemCover = document.createElement('img')
...
function rerenderSearchedContent(requestText) {
  var contentItemsContainer = document.querySelector('.C_Styles');
...
function initSearch() {
  var O_SearchBar = document.querySelector('.O_SearchBar');
  var A_Input = O_SearchBar.querySelector('.A_Input');
  var A_Button = O_SearchBar.querySelector('.A_Button');
  ...
  A_Input.addEventListener('input', function (e) {
    requestText = e.target.value; // if (requestText.length >= 3) {
