...
;// CONCATENATED MODULE: ./src/javascript/mainpage.js

 // window.jQuery = window.$ = $
// Wrap every letter in a span

var textWrapper = document.querySelector('.S_MainPageCover > .W_MainPageCoverText > .anim'); // textWrapper.innerHTML = textWrapper.textContent.replace(
//   /\S/g,
