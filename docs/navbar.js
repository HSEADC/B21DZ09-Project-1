...
var white = document.querySelector('.W_Search').classList.contains('white');
var searchbars = document.querySelectorAll('.W_Search');

for (var i = 0; i < searchbars.length; i++) {
  var root = (0,client/* createRoot */.s)(searchbars[i]);
  root.render( /*#__PURE__*/react.createElement(O_SearchBar, {
    white: white
  }));
}
;// CONCATENATED MODULE: ./src/javascript/navbar.js
